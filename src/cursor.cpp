...
void Cursor::_bind_methods()
{
    ...
    ClassDB::bind_method(D_METHOD("callproc", "procname", "arguments"), &Cursor::callproc);
    ClassDB::bind_method(D_METHOD("execute", "statement", "arguments"), &Cursor::execute);
    ...
    ClassDB::bind_method(D_METHOD("scroll", "amount", "absolute"), &Cursor::scroll);
